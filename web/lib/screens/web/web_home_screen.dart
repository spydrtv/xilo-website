  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          // Hero — slider as background with content overlay
          Stack(
            children: [
              const HeroSlider(),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: AppTheme.spacingMd),
                        Text(
                          'Discover, purchase, and license music from independent artists and AI creators. Support the artists you love directly.',
